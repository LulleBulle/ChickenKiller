...
public class Paint {
	 ...
	 private final Color color1 = new Color(204, 0, 51, 166);
		...
		public Paint(ClientContext ctx) {
			...
			startFeathers = ctx.inventory.first().count();
		}
		...
		public void repaint(Graphics2D g) {
	        ...
	        g.setColor(color3);
	        g.setFont(font2);
	        g.drawString("Runtime: " + hours + ":" + minutes + ":" + seconds, 10, 400);
